...
public class contactActivity extends Activity {
	private ListView lv_contactpeople;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_contactpeople.setAdapter(new SimpleAdapter(this, readContact,
	...
	lv_contactpeople = (ListView) findViewById(R.id.lv_contactpeople);
